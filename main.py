...
boot_line("Initializing", 1, delay=5)
print_dots_done(1)
...
t.gen_text("Welcome to alex-papineau's profile!", 9)
t.clone_frame(15)
t.clear_frame()

# Simulate login prompt
t.gen_text(text="github login: ", row_num=1)
t.gen_typing_text(text="alex-papineau", row_num=1, col_num=14, contin=True, speed=0.1)
t.clone_frame(10)
...
t.clear_frame()
t.gen_text(text="Welcome, alex-papineau! Last Login: 01-01-1970T00:00:01", row_num=1)
t.set_prompt("\x1b[35malex-papineau\x1b[39m@\x1b[32mgithub\x1b[39m:~$ ")
t.gen_prompt(2)
t.gen_typing_text(text="ghfetch -u alex-papineau", row_num=2, contin=True, speed=0.1)

gh_stats = gifos.utils.fetch_github_stats("alex-papineau")
...
\x1b[96mTotal Commits (2024): \x1b[93m{gh_stats.total_commits_last_year}\x1b[0m
...
t.gen_text(text="\x1b[34mHTML", row_num=10)
t.gen_text(text="\x1b[33mCSS", row_num=11)
t.gen_text(text="\x1b[34mJavaScript", row_num=12)
t.gen_text(text="\x1b[32mPHP", row_num=13)

t.gen_prompt(14)
t.gen_typing_text(
    text="cat /proc/frameworks | head -n 2", row_num=14, contin=True, speed=0.1
)
t.gen_text(text="\x1b[32mReact", row_num=15)
t.gen_text(text="\x1b[36mTailwindCSS", row_num=16)

t.gen_prompt(17)
t.gen_typing_text(
    text='echo "nice to meet you" | logo', row_num=17, contin=True, speed=0.5
)
cowsay_output = r"""
nice to meet you
                 \
...
t.gen_text(text=cowsay_output, row_num=18)
t.gen_prompt(26)
# t.clone_frame(60)
